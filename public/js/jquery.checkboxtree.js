...
(function($){
    ...
    $.fn.checkboxTree = function(options) {
        ...
        if (options.collapsable) {
            ...
            options.collapseAnchor = (options.collapseImage.length > 0) ? '<img width=14 height=14 src="'+options.collapseImage+'" onClick="addHeight(20,1);"/>' : '-';
            options.expandAnchor   = (options.expandImage.length > 0)   ? '<img width=14 height=14 src="'+options.expandImage+'"  onClick="addHeight(30,2);" />'   : '+';
            options.leafAnchor     = (options.leafImage.length > 0)     ? '<img width=14 height=14 src="'+options.leafImage+'" />'     : '';
